...
export const topics: Topic[] = [
    ...
    createTopic("Malware Analysis & Sandbox Internals", "security", { status: 'active', slug: 'malware-analysis-and-sandbox-internals', url: '/malware-analysis-and-sandbox-internals' }),
    ...
    createTopic("Hardware Security & Side-Channel Attacks (Spectre, Meltdown)", "security", { status: 'active', slug: 'hardware-security-and-side-channel-attacks-spectre-meltdown', url: '/hardware-security-and-side-channel-attacks-spectre-meltdown', aliases: ['advanced'] }),
    ...
    createTopic("AI Engineering Foundations", "ai"),
    createTopic("Python for AI Engineering", "ai"),
    createTopic("Python for Data & Scientific Computing", "ai"),
    createTopic("NumPy for AI", "ai"),
    createTopic("Data Visualization & Exploratory Data Analysis", "ai"),
    createTopic("Linear Algebra for AI", "ai"),
    createTopic("Probability for AI", "ai"),
    createTopic("Statistics for AI", "ai"),
    createTopic("Calculus & Optimization Mathematics", "ai"),
    createTopic("AI Programming Foundations: APIs, Testing & Reproducibility", "ai"),

    // 2. Machine Learning
    createTopic("Machine Learning Foundations", "ai", { status: 'active', url: "/aicosmos/nn-lab" }),
    createTopic("Linear Regression", "ai"),
    createTopic("Logistic Regression", "ai"),
    createTopic("Classification Algorithms", "ai"),
    createTopic("Decision Trees", "ai"),
    createTopic("Ensemble Learning", "ai"),
    createTopic("K-Nearest Neighbors", "ai"),
    createTopic("Unsupervised Learning & Clustering", "ai"),
    createTopic("Feature Engineering", "ai"),
    createTopic("Model Evaluation & Metrics", "ai"),
    createTopic("Loss Functions", "ai"),
    createTopic("Optimization Algorithms", "ai", { status: 'active', url: "/aicosmos/nn-lab" }),
    createTopic("Regularization", "ai"),
    createTopic("Cross-Validation", "ai"),
    createTopic("Hyperparameter Optimization", "ai"),
    createTopic("Dimensionality Reduction", "ai"),
    createTopic("Machine Learning Pipelines", "ai"),
    createTopic("Feature Selection", "ai"),
    createTopic("Machine Learning Explainability", "ai"),
    createTopic("Complete Machine Learning Project", "ai"),

    // 3. Deep Learning
    createTopic("Neural Network Fundamentals", "ai", { status: 'active', url: "/aicosmos/nn-lab" }),
    createTopic("Activation Functions", "ai"),
    createTopic("Forward Propagation", "ai"),
    createTopic("Neural Network Loss Functions", "ai"),
    createTopic("Backpropagation", "ai"),
    createTopic("Gradient Descent for Neural Networks", "ai"),
    createTopic("Deep Learning Optimizers", "ai"),
    createTopic("PyTorch Fundamentals", "ai"),
    createTopic("Training Neural Networks", "ai"),
    createTopic("Neural Network From Scratch", "ai"),
    createTopic("Neural Network Architectures", "ai"),
    createTopic("Weight Initialization", "ai"),
    createTopic("Normalization in Deep Learning", "ai"),
    createTopic("Dropout & Deep Learning Regularization", "ai"),
    createTopic("Convolutional Neural Networks", "ai"),
    createTopic("Computer Vision", "ai"),
    createTopic("Embeddings & Representation Learning", "ai"),
    createTopic("Transfer Learning", "ai"),
    createTopic("Sequence Models & Modern Sequence Architectures", "ai"),
    createTopic("Complete Deep Learning Project", "ai"),

    // 4. NLP & Transformers
    createTopic("Natural Language Processing Foundations", "ai"),
    createTopic("Tokenization", "ai"),
    createTopic("Word & Text Embeddings", "ai"),
    createTopic("Language Models", "ai"),
    createTopic("Attention Mechanism", "ai"),
    createTopic("Self-Attention", "ai", { status: 'active', url: "/aicosmos/attention-lab" }),
    createTopic("Multi-Head Attention", "ai"),
    createTopic("Positional Encoding & Position Representations", "ai"),
    createTopic("Transformer Architecture", "ai"),
    createTopic("Build a Transformer From Scratch", "ai"),

    // 5. LLM Engineering
    createTopic("Large Language Models", "ai", { status: 'active', url: "/aicosmos" }),
    createTopic("LLM Pretraining & Next-Token Prediction", "ai"),
    createTopic("Instruction Tuning & Fine-Tuning", "ai"),
    createTopic("Parameter-Efficient Fine-Tuning: LoRA & QLoRA", "ai"),
    createTopic("Prompt Engineering & Context Engineering", "ai"),
    createTopic("LLM Context & Context Windows", "ai"),
    createTopic("LLM Reasoning & Inference-Time Generation", "ai"),
    createTopic("LLM APIs, Model Selection & Routing", "ai"),
    createTopic("Structured Outputs & Schema-Constrained Generation", "ai"),
    createTopic("Function Calling, Tool Use & LLM Application Engineering", "ai"),

    // 6. RAG Engineering
    createTopic("RAG Fundamentals", "ai", { status: 'active', url: "/aicosmos/rag-lab" }),
    createTopic("Documents, Data Ingestion & Parsing", "ai"),
    createTopic("Text Chunking & Context Construction", "ai"),
    createTopic("Embeddings for Retrieval", "ai"),
    createTopic("Vector Databases & Vector Indexes", "ai"),
    createTopic("Information Retrieval & Hybrid Search", "ai"),
    createTopic("Reranking & Query Transformation", "ai"),
    createTopic("RAG Generation, Grounding & Citations", "ai"),
    createTopic("RAG Evaluation & Retrieval Metrics", "ai"),
    createTopic("Complete Production RAG System", "ai"),

    // 7. AI Agents
    createTopic("AI Agent Fundamentals", "ai", { status: 'active', url: "/aicosmos/agent-lab" }),
    createTopic("AI Tools & Tool Design", "ai"),
    createTopic("Agent Loops, State & Durable Execution", "ai"),
    createTopic("Agent Planning, Reasoning & ReAct", "ai"),
    createTopic("Agent Memory & Context Management", "ai"),
    createTopic("MCP & AI Tool Protocols", "ai"),
    createTopic("Agent Workflows, Human-in-the-Loop & Orchestration", "ai"),
    createTopic("Multi-Agent Systems & Coordination", "ai"),
    createTopic("Agent Security, Evaluation & Reliability", "ai"),
    createTopic("Complete AI Agent System", "ai"),

    // 8. Production AI & Systems
    createTopic("AI Evaluation & Evals", "ai"),
    createTopic("AI Observability, Tracing & Monitoring", "ai"),
    createTopic("AI Security, Guardrails & Prompt Injection", "ai"),
    createTopic("AI Cost, Latency, Caching & Performance Optimization", "ai"),
    createTopic("AI Deployment, CI/CD & Infrastructure", "ai"),
    createTopic("AI Inference, Quantization & Model Serving", "ai"),
    createTopic("Scalable AI Systems, GPUs & Distributed Inference", "ai"),
    createTopic("Multimodal AI & Vision-Language Systems", "ai"),
    createTopic("AI System Design", "ai"),
    createTopic("AI Engineering Capstone", "ai"),
    ...
    createTopic("Linkers, Loaders & Executables (ELF, PE)", "corecs", { status: 'active', slug: 'linkers-loaders-and-executables-elf-pe', url: '/linkers-loaders-and-executables-elf-pe' }),
    createTopic("C & C++ Systems Programming (Memory, Pointers)", "corecs"),
    createTopic("Java & JVM Internals (Garbage Collection, Bytecode)", "corecs", { status: 'active', slug: 'java-and-jvm-internals-garbage-collection-bytecode', url: '/java-and-jvm-internals-garbage-collection-bytecode' }),
    createTopic("Computer Architecture (CPU, Caches)", "corecs", { status: 'active', slug: 'computer-architecture-cpu-caches', url: '/computer-architecture-cpu-caches' }),
    createTopic("Computer Networks Internals (TCP/IP)", "corecs", { status: 'active', slug: 'computer-networks-internals-tcpip', url: '/computer-networks-internals-tcpip' }),
