...
export const topics: Topic[] = [
    ...
    createTopic("JWT & OAuth2 Flow Visualizer", "fullstack"),
    ...
    createTopic("Sorting Algorithms Visualizer", "dsa"),
    createTopic("Binary Search Visualizer", "dsa"),
    ...
    createTopic("GPU & CUDA Programming Basics Visualizer", "ai"),
    createTopic("Distributed Training & Parallelization Visualizer", "ai"),
    createTopic("ML Compiler & Inference Optimization Visualizer", "ai"),

    // Core Computer Science
    createTopic("Pointers & Memory Layout Visualizer", "corecs"),
    ...
    createTopic("System Calls Visualizer", "corecs"),
    createTopic("Interrupts & IDT Visualizer", "corecs"),
    createTopic("TCP Handshake Visualizer", "corecs"),
    createTopic("TCP vs UDP Deep Comparison & Simulator", "corecs"),
    createTopic("DNS Lookup Visualizer", "corecs"),
    createTopic("HTTP Lifecycle Visualizer", "corecs"),
    createTopic("HTTP/2 & HTTP/3 Internals Visualizer", "corecs"),
    createTopic("SSL/TLS Handshake Visualizer", "corecs"),
    createTopic("TLS Internals Beyond Handshake Visualizer", "corecs"),
    ...
    createTopic("LSM Tree Visualizer", "corecs"),
    createTopic("Write-Ahead Log & Compaction Visualizer", "corecs"),
    createTopic("MVCC & Snapshot Isolation Visualizer", "corecs"),
    ...
    createTopic("VM & Bytecode Execution Visualizer", "corecs"),
    ...
    createTopic("Side-Channel Attacks & Defenses Visualizer", "advanced"),
    ...
    createTopic("Raft Consensus Algorithm Visualizer", "advanced"),
    createTopic("Leader Election Visualizer", "advanced"),
    createTopic("Vector Clocks & Causality Visualizer", "advanced"),
    createTopic("Gossip Protocol & Partition Simulation Visualizer", "advanced"),
    createTopic("Bootloader & Kernel Boot Process Visualizer", "advanced"),
