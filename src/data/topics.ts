...
export const topics: Topic[] = [
    ...
    createTopic("Data Visualization for AI", "ai"),
    createTopic("Linear Algebra for AI", "ai"),
    createTopic("Probability for AI", "ai"),
    createTopic("Statistics for AI", "ai"),
    createTopic("Calculus & Optimization Mathematics for AI", "ai"),
    createTopic("AI Programming Foundations", "ai"),
    ...
    createTopic("Unsupervised Learning", "ai"),
    ...
    createTopic("Sequence Models", "ai"),
    ...
    createTopic("Prompt Engineering", "ai"),
    createTopic("LLM Context & Context Windows", "ai"),
    createTopic("LLM Decoding & Text Generation", "ai"),
    createTopic("LLM APIs & Model Providers", "ai"),
    createTopic("Structured Outputs & Schema-Constrained Generation", "ai"),
    createTopic("Function Calling & Tool Calling", "ai"),
    createTopic("LLM Application Engineering", "ai"),

    // 6. RAG Engineering
    createTopic("RAG Fundamentals", "ai", { status: 'active', url: "/aicosmos/rag-lab" }),
    createTopic("Documents & Data Ingestion", "ai"),
    createTopic("Text Chunking Strategies", "ai"),
    createTopic("Embeddings for Retrieval", "ai"),
    createTopic("Vector Databases & Vector Indexes", "ai"),
    createTopic("Information Retrieval", "ai"),
    createTopic("Reranking & Hybrid Search", "ai"),
    createTopic("RAG Generation, Grounding & Citations", "ai"),
    createTopic("RAG Evaluation", "ai"),
    ...
    createTopic("Agent Loops & State", "ai"),
    createTopic("Agent Planning & Reasoning", "ai"),
    createTopic("Agent Memory & Context Management", "ai"),
    createTopic("MCP & AI Tool Protocols", "ai"),
    createTopic("Agent Workflows & Orchestration", "ai"),
    createTopic("Multi-Agent Systems", "ai"),
    createTopic("Agent Evaluation & Reliability", "ai"),
    ...
    createTopic("AI Cost, Latency & Performance Optimization", "ai"),
    createTopic("AI Deployment & Infrastructure", "ai"),
    createTopic("AI Inference & Model Serving", "ai"),
    createTopic("Scalable AI Systems & Distributed Inference", "ai"),
    createTopic("AI System Design", "ai"),
    createTopic("AI Engineering Capstone Architecture", "ai"),
    createTopic("Complete AI Engineering Capstone", "ai"),
