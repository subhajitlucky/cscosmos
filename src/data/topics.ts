...
export const topics: Topic[] = [
    ...
    createTopic("Python Data Structures & Scientific Computing", "ai"),
    createTopic("NumPy for Machine Learning", "ai"),
    createTopic("Pandas & Data Manipulation", "ai"),
    createTopic("Data Cleaning & Preprocessing", "ai"),
    createTopic("Datasets & Data Pipelines", "ai"),
    createTopic("Functions, Modules & OOP for AI", "ai"),
    createTopic("APIs, JSON & AI Service Integration", "ai"),
    createTopic("Git & Reproducible AI Projects", "ai"),
    createTopic("AI Development Environments & Tooling", "ai"),

    // 2. Mathematics for AI
    createTopic("Vectors & Vector Spaces", "ai"),
    createTopic("Matrices & Linear Algebra", "ai"),
    createTopic("Matrix Decompositions", "ai"),
    createTopic("Probability Fundamentals", "ai"),
    createTopic("Random Variables & Distributions", "ai"),
    createTopic("Statistics for Machine Learning", "ai"),
    createTopic("Bayesian Reasoning", "ai"),
    createTopic("Derivatives & Partial Derivatives", "ai"),
    createTopic("Gradients & Jacobians", "ai"),
    ...
    createTopic("Supervised Learning", "ai"),
    ...
    createTopic("Gradient Boosting & XGBoost", "ai"),
    createTopic("Support Vector Machines (Margins)", "ai"),
    createTopic("k-Nearest Neighbors", "ai"),
    createTopic("Unsupervised Learning", "ai"),
    createTopic("Clustering (k-Means & Hierarchical)", "ai"),
    createTopic("Dimensionality Reduction (PCA)", "ai"),
    createTopic("Feature Engineering & Selection", "ai"),
    createTopic("Model Evaluation & Cross-Validation", "ai"),

    // 4. Deep Learning
    createTopic("Neural Networks (Backpropagation)", "ai", { status: 'active', url: '/aicosmos/nn-lab' }),
    createTopic("Perceptrons & Activation Functions", "ai"),
    createTopic("Loss Functions", "ai"),
    createTopic("Backpropagation & Computational Graphs", "ai"),
    createTopic("Optimizers (SGD, Adam & AdamW)", "ai"),
    createTopic("Regularization & Normalization", "ai"),
    createTopic("PyTorch & Tensor Programming", "ai"),
    createTopic("Convolutional Neural Networks (Filters)", "ai"),
    createTopic("Recurrent Neural Networks (Sequences)", "ai"),
    createTopic("Autoencoders & Representation Learning", "ai"),
    ...
    createTopic("Distributed Deep Learning", "ai"),
    createTopic("Deep Learning Debugging & Experimentation", "ai"),

    // 5. Transformers
    createTopic("Tokenization & Subword Algorithms", "ai"),
    createTopic("Token IDs & Vocabulary Design", "ai"),
    createTopic("Embeddings & Representation Learning", "ai"),
    createTopic("Positional Encoding", "ai"),
    createTopic("Query, Key & Value (Q/K/V)", "ai"),
    createTopic("Attention Scores & Softmax", "ai"),
    ...
    createTopic("Causal & Cross Attention", "ai"),

    // 6. LLM Engineering
    createTopic("Large Language Models (LLMs)", "ai", { status: 'active', url: '/aicosmos' }),
    createTopic("LLM Pretraining & Next-Token Prediction", "ai"),
    createTopic("Context Windows & Attention Limits", "ai"),
    createTopic("Prompt Engineering", "ai"),
    createTopic("System Prompts & Instruction Hierarchy", "ai"),
    createTopic("Structured Outputs & Constrained Generation", "ai"),
    createTopic("Function Calling & Tool Use", "ai"),
    createTopic("Streaming, Batching & Model APIs", "ai"),
    createTopic("Model Selection & Routing", "ai"),
    createTopic("LLM Cost & Latency Engineering", "ai"),

    // 7. RAG & Knowledge Systems
    createTopic("Embeddings & Semantic Search", "ai"),
    createTopic("Vector Databases & Indexes", "ai"),
    createTopic("Document Chunking & Ingestion", "ai"),
    createTopic("Retrieval-Augmented Generation (RAG)", "ai", { status: 'active', url: '/aicosmos/rag-lab' }),
    createTopic("Hybrid Retrieval", "ai"),
    createTopic("Reranking & Query Expansion", "ai"),
    createTopic("Metadata Filtering & Access Control", "ai"),
    createTopic("Knowledge Graphs & Graph RAG", "ai"),
    createTopic("RAG Evaluation & Groundedness", "ai"),
    createTopic("Advanced Retrieval Architectures", "ai"),

    // 8. AI Agents
    createTopic("AI Agents Fundamentals", "ai", { status: 'active', url: '/aicosmos/agent-lab' }),
    createTopic("Agent Loops & State Machines", "ai"),
    createTopic("Planning & Reasoning Strategies", "ai"),
    createTopic("Tool Use & Computer Interaction", "ai"),
    createTopic("Agent Memory & Context Management", "ai"),
    createTopic("MCP & Model Context Protocol", "ai"),
    createTopic("Multi-Agent Systems & Coordination", "ai"),
    createTopic("Agent Evaluation & Reliability", "ai"),

    // 9. Production AI
    createTopic("ML Engineering & Experiment Tracking", "ai"),
    createTopic("Model Evaluation & AI Evals", "ai"),
    createTopic("AI Observability & Tracing", "ai"),
    createTopic("Model Serving & Inference APIs", "ai"),
    createTopic("Inference Optimization & Quantization", "ai"),
    createTopic("GPU Inference & KV Cache", "ai"),
    createTopic("AI Security, Guardrails & Prompt Injection", "ai"),

    // 10. AI Systems & Advanced Engineering
    createTopic("Instruction Tuning & Fine-Tuning", "ai"),
    createTopic("LoRA, QLoRA & Parameter-Efficient Fine-Tuning", "ai"),
    createTopic("Multimodal AI & Vision-Language Models", "ai"),
    createTopic("Distributed AI & Scalable Inference", "ai"),
    createTopic("AI Systems Design & Capstone Architecture", "ai"),
