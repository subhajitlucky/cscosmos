    ...
    <div className="space-y-16 pb-16">
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <Link
                ...
                className="flex items-center space-x-2 rounded-lg border border-[var(--rust-border)] bg-[var(--rust-surface)] px-5 py-3 text-sm font-bold text-[var(--rust-text)] hover:bg-[var(--rust-surface-2)] hover:border-[var(--rust-primary-border)] transition-all"
              >
            ...
            {/* Trust / Spec Badges */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-[var(--rust-border)]">
              <div className="flex items-center space-x-2 text-xs text-[var(--rust-muted)] font-mono">
                <CheckCircle2 className="h-4 w-4 text-[var(--rust-emerald)]" />
                <span>Zero-Cost Moves</span>
              </div>
              <div className="flex items-center space-x-2 text-xs text-[var(--rust-muted)] font-mono">
                <CheckCircle2 className="h-4 w-4 text-[var(--rust-cyan)]" />
                <span>Compile-Time NLL</span>
              </div>
              <div className="flex items-center space-x-2 text-xs text-[var(--rust-muted)] font-mono">
                <Zap className="h-4 w-4 text-[var(--rust-amber)]" />
                <span>Fearless Concurrency</span>
              </div>
              <div className="flex items-center space-x-2 text-xs text-[var(--rust-muted)] font-mono">
                <HardDrive className="h-4 w-4 text-[var(--rust-purple)]" />
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/rustviz/ownership-lab" className="rust-card rounded-xl p-6 group block">
          ...
          <Link href="/rustviz/borrow-checker" className="rust-card rounded-xl p-6 group block">
          ...
          <Link href="/rustviz/lifetimes-lab" className="rust-card rounded-xl p-6 group block">
          ...
          <Link href="/rustviz/smart-pointers" className="rust-card rounded-xl p-6 group block">
          ...
          <Link href="/rustviz/concurrency-lab" className="rust-card rounded-xl p-6 group block">
          ...
          <Link href="/rustviz/pitfalls" className="rust-card rounded-xl p-6 group block">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/rustviz/concepts" className="text-xs font-bold text-[var(--rust-primary)] hover:underline flex items-center">
