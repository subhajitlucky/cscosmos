...
import { AUTH_FLASHCARDS, type AuthFlashcard } from '../data/flashcards';
...
export default function Flashcards() {
  ...
  const filteredCards = selectedCat === 'All'
    ? AUTH_FLASHCARDS
    : AUTH_FLASHCARDS.filter((c) => c.category === selectedCat);
    ...
    <div className="space-y-8 pb-20 max-w-4xl mx-auto px-4 sm:px-6 pt-10">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-foreground tracking-tight">
          Security &amp; Auth Architect Flashcards
        </h1>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {['All', 'OAuth & OIDC', 'JWT & Cryptography', 'Web Storage & Cookies', 'Authorization & Access Control'].map((cat) => (
          <button
            key={cat}
            onClick={() => {
              setSelectedCat(cat);
