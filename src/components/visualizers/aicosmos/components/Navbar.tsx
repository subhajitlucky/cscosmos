...
import { ArrowLeft, Sparkles, Layers, Activity, BookOpen, Menu, X, Bot, Network, ShieldAlert } from 'lucide-react';
...
export function Navbar() {
  ...
  const navLinks = [
    { label: 'Concept Map', href: '/aicosmos/learn', icon: BookOpen },
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[var(--ai-border-subtle)] bg-[var(--ai-bg)]/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/aicosmos" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              <span className="font-display font-bold text-lg tracking-tight text-[var(--ai-text)] flex items-center gap-1">
                AI<span className="text-[var(--ai-primary)] font-mono">::COSMOS</span>
              </span>
              <span className="text-[9px] font-mono text-[var(--ai-muted)] tracking-wider uppercase -mt-1">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2 px-3.5 py-1.5 rounded-md text-xs font-medium transition-all ${
                  isActive
                    ? 'bg-[var(--ai-primary)]/10 text-[var(--ai-primary)] border border-[var(--ai-border)]'
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg border border-[var(--ai-border-subtle)] text-[var(--ai-muted)] hover:text-[var(--ai-text)]"
      ...
      {/* Mobile drawer */}
      {mobileOpen && (
        <div className="md:hidden border-b border-[var(--ai-border-subtle)] bg-[var(--ai-surface)] px-6 py-4 space-y-2">
          {navLinks.map((item) => {
            const Icon = item.icon;
            return (
              <Link
                ...
                className="flex items-center gap-3 px-3 py-2 rounded text-sm text-[var(--ai-muted)] hover:text-[var(--ai-primary)] hover:bg-[var(--ai-surface-2)]"
              >
