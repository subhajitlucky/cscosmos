    ...
    return (
        <div className="h-[calc(100vh-6rem)] flex flex-col pt-2 pb-6">
            <div className="flex items-center justify-between mb-4">
                <Link href="/html-cosmos/problems" className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors text-sm font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 overflow-hidden">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex-1 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden min-h-[300px]">
                        <CodeEditor code={code} onChange={setCode} />
                    </div>
                </div>

                <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden flex flex-col min-h-[300px]">
                    <div className="bg-slate-950 px-4 py-2 border-b border-slate-800 text-xs text-slate-400 font-mono">
                        Live Preview Output
                    </div>
