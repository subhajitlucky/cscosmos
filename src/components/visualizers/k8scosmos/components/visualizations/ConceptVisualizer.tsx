...
function KubernetesOverview() {
  return (
    <div className="relative bg-[#326CE5]/10 rounded-xl p-8 border border-[#326CE5]/30 h-64 overflow-hidden">
      <motion.div
...
function NodeAffinity() {
  return (
    <div className="bg-fuchsia-500/10 rounded-xl p-6 border border-fuchsia-500/20">
      <div className="flex items-center gap-4">
...
function PodAntiAffinity() {
  return (
    <div className="bg-slate-500/10 rounded-xl p-6 border border-slate-500/20">
