...
const Home = dynamic(() => import('@/components/visualizers/cryptviz/pages/Home'), { ssr: false });
const Learn = dynamic(() => import('@/components/visualizers/cryptviz/pages/Learn'), { ssr: false });
const TopicPage = dynamic(() => import('@/components/visualizers/cryptviz/pages/TopicPage'), { ssr: false });
const Playground = dynamic(() => import('@/components/visualizers/cryptviz/pages/Playground'), { ssr: false });
...
export default function RouteClientShell({ slug }: { slug: string[] }) {
  ...
  return (
    <RouteProvider basePath="/cryptviz" params={routeParams}>
